       ...
       function setParms(obj,parms)
        ...
        function integrateCommands(obj)
            ...
            for i=1:obj.numSamples-1
                s = (i-1)*ds;  
            	obj.distArray(i) = s;
            	obj.curvArray(i) = s*(a+b*s)*(s-sf);
		t = obj.poseArray(3, i) + obj.curvArray(i)*ds;
		obj.poseArray(1, i+1) = obj.poseArray(1, i) + cos(t)*ds;
		obj.poseArray(2, i+1) = obj.poseArray(2, i) + sin(t)*ds;
		obj.poseArray(3, i+1) = t;
            end
            i = obj.numSamples;
            s = (i-1)*ds;  
            obj.distArray(i) = s;
