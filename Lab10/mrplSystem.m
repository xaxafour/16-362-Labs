classdef mrplSystem < handle
    ...
    methods(Access = public)
        ...
        function executeTrajectory(obj, targetPose, controller, delay, Vmax, figureNum, k)
            ...
            obj.follower = trajectoryFollower(obj.robot, delay, trajectory, obj.refCurrentPose, obj.encCurrentPose, controller,obj.localizer,obj.k);
            ...
            %trajectory. To plantrajectory from the present position, make
